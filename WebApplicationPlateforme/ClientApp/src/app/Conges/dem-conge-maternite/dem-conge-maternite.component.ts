...
@Component({
  selector: 'app-dem-conge-maternite',
  templateUrl: './dem-conge-maternite.component.html',
  styleUrls: ['./dem-conge-maternite.component.css']
})
export class DemCongeMaterniteComponent implements OnInit {
  ...
  getUserConnected() {
    ...
    this.UserService.getUserProfileObservable().subscribe(res => {
      ...
      this.notif.TextNotification = "طلب إجازة الامومة من الموظف  " + res.fullName
