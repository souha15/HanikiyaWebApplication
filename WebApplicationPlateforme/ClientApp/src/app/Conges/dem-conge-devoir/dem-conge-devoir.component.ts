...
@Component({
  selector: 'app-dem-conge-devoir',
  templateUrl: './dem-conge-devoir.component.html',
  styleUrls: ['./dem-conge-devoir.component.css']
})
export class DemCongeDevoirComponent implements OnInit {
