...
@Component({
  selector: 'app-dem-conge-deces',
  templateUrl: './dem-conge-deces.component.html',
  styleUrls: ['./dem-conge-deces.component.css']
})
export class DemCongeDecesComponent implements OnInit {
  ...
  getUserConnected() {
    ...
    this.UserService.getUserProfileObservable().subscribe(res => {
      ...
      this.notif.TextNotification = "طلب إجازة وفاة من الموظف  " + res.fullName
