...
@Component({
  selector: 'app-dem-conge-haj',
  templateUrl: './dem-conge-haj.component.html',
  styleUrls: ['./dem-conge-haj.component.css']
})
export class DemCongeHajComponent implements OnInit {
