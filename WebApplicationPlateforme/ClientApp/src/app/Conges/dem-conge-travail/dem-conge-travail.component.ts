...
@Component({
  selector: 'app-dem-conge-travail',
  templateUrl: './dem-conge-travail.component.html',
  styleUrls: ['./dem-conge-travail.component.css']
})
export class DemCongeTravailComponent implements OnInit {
  ...
  getUserConnected() {
    ...
    this.UserService.getUserProfileObservable().subscribe(res => {
      ...
      this.notif.TextNotification = "طلب إجازة بدل العمل الإضافي من الموظف  " + res.fullName
  ...
  onSubmit(form: NgForm) {
    ...
    this.conge.type = "إجازة بدل العمل الإضافي"
